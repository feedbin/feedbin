        ...
        def feed_profile(subscription_presenter)
          div(class: "border rounded-lg mb-14") do
            div(class: "flex items-center gap-2 p-4") do
              ...
              link_to "Edit", edit_subscription_path(subscription.feed), remote: true, class: "button button-secondary !ml-auto", data: { behavior: "feed_settings", open_dialog: Dialog::EditSubscription.dom_id }
            end
