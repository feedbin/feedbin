...
class EntriesSearchControllerTest < ActionController::TestCase
  ...
  #   @entry.update!(title: "Dog Story", content: "About dogs")
  #   reindex_search
  #   @user.starred_entries.create!(entry: @entry)
  #   login_as @user
  #   get :search, params: {query: "dogs OR is:starred word_count:[5 TO 500]"}, xhr: true
  #   assert_response :success
  #   assert_equal(@entry, assigns(:entries).first)
  # end
  #
  ...
  #
  #   login_as @user
  #   get :search, params: {query: "tagged tag_id:#{tag.id}"}, xhr: true
  #   assert_response :success
  #   assert_equal(@entry, assigns(:entries).first)
  # end
  #
  ...
  test "should handle exact title search" do
    @entry.update!(title: "Exact Title Search", content: "Content")
    reindex_search
    login_as @user
