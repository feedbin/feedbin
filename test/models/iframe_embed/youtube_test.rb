...
class IframeEmbed::YoutubeTest < ActiveSupport::TestCase
  ...
  # A channel with no avatar row yet still shows the thumbnail url the card
  # always showed, rather than losing its picture.
  test "profile_image falls back to the thumbnail when the channel has no row" do
    ...
    assert_equal "https://yt3.ggpht.com/medium.jpg", embed.profile_image
  end
end
