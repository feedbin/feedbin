...
class ContentFormatterTest < ActiveSupport::TestCase
  ...
  test "should format content" do
    expected = %(<p><a href="http://kottke.org/link"><img src="" data-camo-src="https://example.com/s42HuUxeWWnLk0J32ALOSruShbAG5ZQbyW61cKdvHLhU=/http://kottke.org/img.png" data-canonical-src="http://kottke.org/img.png"></a></p>)
